...
<div style="max-width:600px;margin:40px auto;background:#ffffff;border-radius:12px;overflow:hidden;">
  <div style="background:#0a0a0a;padding:28px 32px;">
    <div style="font-size:20px;font-weight:800;color:#ffffff;letter-spacing:-0.02em;">
      PACC<span style="color:#E8461E;font-size:13px;">®</span>
    </div>
  ...
  <div style="padding:32px;">
    ...
    <table style="width:100%;border-collapse:collapse;font-size:13px;">
      ...
      <tr>
        ...
        <td style="padding:14px 0;text-align:right;font-weight:700;font-size:18px;color:#E8461E;">$${Number(quote.total_inc_gst).toLocaleString(undefined, { maximumFractionDigits: 2 })}</td>
      </tr>
    </table>
